        ...
        <div class="bg-gray-100 shadow-sm relative overflow-hidden shadow-slate-500 rounded-2xl flex h-[90vh] mx-20 my-8">
            ...
            <div class="bg-white relative h-[100%] w-[15%]">
                ...
                <div class="flex items-center gap-2 bg-gray-100 w-44 justify-center py-1 mx-auto 2xl:ml-6 rounded-lg">
                    ...
                    <div class="pt-1">
                        <p class="font-semibold text-[11px]"><?=$_SESSION['user']['nom']?></p>
                    ...
                    <div>
                        <ul class="flex items-center gap-3">
                            ...
                            <li
                                ...
                                <p class="text-[10px] font-semibold"><?=$_SESSION['user']['nom']?></p>
                    ...
                    <div class="bg-white py-4 px-4 mx-6 rounded-lg mt-2.5">
                        <ul class="flex items-center">
                            ...
                            <li class="flex gap-5 items-center pl-6">
                                <img class="w-14 h-14 shadow-md shadow-slate-300" src="img/portfolio/<?=$i?>.jpg" alt="">
                                <div>
                                    <p class="font-semibold text-sm"><?php echo $row ['nom_produit'];?></p>
                                    <p class="text-xs pt-1 opacity-[0.6]"><?php echo $row ['description'];?></p>
                                </div>
                            </li>
                            ...
                            <li  class="pr-8 2xl:pl-10">
                                <p class="font-semibold text-sm"><?php echo $row ['prix'];?>$</p>
                            </li>

                            <li class="pr-8 2xl:pl-9">
                                <p class="font-semibold text-sm"><?php echo $row ['quantite'];?></p>
                            </li>
                            ...
                            <li  class="pl-8 2xl:pl-20">
                                <ul class="flex items-center gap-5 2xl:gap-8">
                                    <li><a href="./editProduct?id=<?= $row ['id'];?>"
                                    ...
                                    <li class="bg-gray-100 px-1.5 rounded-md hover:bg-gray-200 duration-300 w-6"><a
                                            href="./deleteProduct?id=<?= $row ['id'];?>"><i class="fa-solid text-red-500 fa-trash-can text-xs"></i></a></li>
                                </ul>
                            </li>
                    </ul>
                    </div>
                        ...
                        <ul class="flex items-center">
                            ...
                            <li class="pl-8 2xl:pl-20">
                                <ul class="flex items-center gap-5 2xl:gap-8">
                                    ...
                                    <li class="bg-gray-100 px-1.5 rounded-md hover:bg-gray-200 duration-300 w-6"><a
                                            href="./controller/delete.php"><i class="fa-solid text-red-500 fa-trash-can text-xs"></i></a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
                        ...
                        <ul class="flex items-center">
                            ...
                            <li class="pl-8 2xl:pl-20">
                                <ul class="flex items-center gap-5 2xl:gap-8">
                                    ...
                                    <li class="bg-gray-100 px-1.5 rounded-md hover:bg-gray-200 duration-300 w-6"><a
                                            href="./controller/delete.php"><i class="fa-solid fa-trash-can text-red-500 text-xs"></i></a></li>
                                </ul>
                            </li>
                        </ul>
                    </div> -->
