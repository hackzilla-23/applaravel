    ...
    <div class="relative mt-[60px]  overflow-auto bg-white w-[80vw] h-[88vh] rounded-tl-xl rounded-t-xl ">
        ...
        <div class=" p-4  mt-5 w-[75vw] h-auto bg-gray-200 ml-auto mr-4">
            <div class=" w-[90%] lg:w-[55%] mx-auto bg-white h-auto p-3">
                ...
                <p class="my-6 text-gray-400 text-xl">Votre expérience de trading doit être fluide et ininterrompue. Pour y parvenir et profiter de tous nos services, il vous suffit de procéder à la vérification de votre compte.</p>
