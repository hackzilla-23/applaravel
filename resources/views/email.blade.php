...
<body class="">
    <div class="relative mt-[60px]  overflow-auto bg-white w-[80vw] h-[88vh] rounded-tl-xl rounded-t-xl ">
        <div class="">
            <div
                class="bg-white fixed w-[79vw] z-[100] overflow-hidden h-14 rounded-tl-xl rounded-tr-xl shadow-md grid grid-cols-1 gap-3 lg:grid-cols-2 items-center px-4">
                <div class="flex gap-7 ">
                    ...
                    <a href="#" class="text-gray-400"><img
                            src="{{ asset('img/person_24dp_5F6368_FILL0_wght400_GRAD0_opsz24 (1).svg') }}"></a>
                    <a href="#" class="text-gray-400"><img src="{{ asset('img/mail_outline_24dp_5F6368.svg') }}"
                            alt=""></a>
                    <a href="#" class="text-gray-400"><img
                            src="{{ asset('img/dashboard_24dp_5F6368_FILL0_wght400_GRAD0_opsz24.svg') }}"
                            alt=""></a>
                    <a href="#" class="text-gray-400"><img
                            src="{{ asset('img/production_quantity_limits_24dp_5F6368.svg') }}" alt=""></a>
        ...
        <div class=" p-4  mt-5 w-[75vw] h-auto bg-gray-200 ml-auto mr-4">
            <div class=" w-[90%] lg:w-[55%] mx-auto bg-white h-auto p-3">
                ...
                <p class="my-6 text-gray-400 text-xl">Supprimer les limitations de votre compte
                    ...
                    fonds.</p>
                <p class="my-6 text-gray-400 text-xl">Si vous avez besoin d’aide avec vos documents, vous pouvez
                    consulter l’article de notre Centre d’aide ici ou contacter notre équipe d’assistance.</p>
        ...
        <div class="pl-[75px] my-4">
            ...
            <button
                class=" border-solid border-black border-2 px-4 rounded-3xl py-2 hover:bg-gray-300 duration-300 ">reply</button>
            <button
                class=" border-solid border-black border-2 px-4 rounded-3xl py-2 hover:bg-gray-300 duration-300 ">Forward</button>
        </div>
    </div>
</body>
