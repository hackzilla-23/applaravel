    ...
    <div class="bg-gray-100 shadow-sm relative overflow-hidden shadow-slate-500 rounded-2xl flex h-[90vh] mx-20 my-8">
        ...
        <div class="bg-white h-[100%] w-[15%]">
            ...
            <div class="flex items-center gap-2 bg-gray-100 w-44 justify-center py-1 mx-auto rounded-lg">
                ...
                <div class="pt-1">
                    <p class="font-semibold text-[11px]">Mohamed Said</p>
                    <p class="text-[9px]">Marketing</p>
                </div>
                <i class="fa-solid fa-sliders text-lg px-2 pb-1"></i>
            </div>

            <ul class="flex flex-col gap-5 pl-6 pt-8 pb-12">
                <li class="text-sm">
            ...
            <div class="bg-gray-100 mx-auto w-40 py-4 rounded-lg">
                ...
                <ul class="flex gap-2 items-center justify-center">
                    ...
                    <li><a href="#" class="text-[12px] text-gray-400 hover:opacity-[0.7] duration-300">LATER</a>
                    </li>
                </ul>
            </div>

            <p class="text-[9px] pl-6 pt-6 pb-3 opacity-[0.5] font-medium">STORE PREFERENCES</p>

            <ul class="flex flex-col gap-4 pb-3 pl-6">
                <li>
            ...
            <p class="text-[10px] pl-6 opacity-[0.5]"><i class="fa-regular fa-copyright"></i> 2024 MarketX</p>
        </div>
        ...
        <div class="w-[85%] overflow-auto relative">
            <div class="flex items-center justify-between pt-6 px-7">
                <div class="bg-gray-200 pl-2.5 rounded-md overflow-hidden">
                    ...
                    <input type="text" class="w-96 bg-gray-200 outline-none py-1.5 text-[12px]"
                        placeholder="Search...">
                </div>

                <div>
                    <ul class="flex items-center gap-3">
                        <li class="bg-gray-200 hover:bg-gray-300 duration-300 px-2 py-0.5 rounded-md"><a
                                href="#"><i class="fa-solid fa-ellipsis"></i></a></li>
                        <li class="bg-gray-200 hover:bg-gray-300 duration-300 px-2 py-0.5 rounded-md"><a
                                href="#"><i class="fa-solid fa-bell"></i></a></li>
                        <li
                            ...
                            <p class="text-[10px] font-semibold">Mohamed</p>
                            <i class="text-[10px] fa-solid fa-chevron-down"></i>
                        </li>
                        <li class="bg-gray-200 px-2 py-0.5 rounded-md hover:bg-gray-300 duration-300"><a
                                href="#"><i class="fa-solid fa-ellipsis"></i></a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="flex flex-col pb-2.5">
                ...
                <div class="bg-white py-4 px-4 mx-6 rounded-lg mt-2.5">
                    <ul class="flex items-center">
                        ...
                        <li class="flex gap-5 items-center pl-6">
                            <img class="w-14 h-14 shadow-md shadow-slate-300" src="img/portfolio/1.jpg"
                                alt="">
                            <div>
                        ...
                        <li class="pl-8">
                            <ul class="flex items-center gap-5">
                                ...
                                <li class="bg-gray-100 px-1.5 rounded-md hover:bg-gray-200 duration-300 w-6"><a
                                        href="#"><i class="fa-solid fa-ellipsis text-xs"></i></a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                ...
                <div class="bg-white py-4 px-4 mx-6 rounded-lg mt-2.5">
                    <ul class="flex items-center">
                        ...
                        <li class="flex gap-5 items-center pl-6">
                            <img class="w-14 h-14 shadow-md shadow-slate-300" src="img/portfolio/2.jpg"
                                alt="">
                            <div>
                                <p class="font-semibold text-sm">Kitchen Table</p>
                                <p class="text-xs pt-1 opacity-[0.6]">woodyFurniture Offer new products...</p>
                            </div>
                        </li>
                ...
                <div class="bg-white py-4 px-4 mx-6 rounded-lg mt-2.5">
                    <ul class="flex items-center">
                        ...
                        <li class="flex gap-5 items-center pl-6">
                            <img class="w-14 h-14 shadow-md shadow-slate-300" src="img/portfolio/3.jpg"
                                alt="">
                            <div>
                                <p class="font-semibold text-sm">Patio Decor Set</p>
                                <p class="text-xs pt-1 opacity-[0.6]">woodyFurniture Offer new products...</p>
                            </div>
                        </li>
                ...
                <div class="bg-white py-4 px-4 mx-6 rounded-lg mt-2.5">
                    <ul class="flex items-center">
                        ...
                        <li class="flex gap-5 items-center pl-6">
                            <img class="w-14 h-14 shadow-md shadow-slate-300" src="img/portfolio/4.jpg"
                                alt="">
                            <div>
                                <p class="font-semibold text-sm">Modern Wide Kitchen</p>
                                <p class="text-xs pt-1 opacity-[0.6]">woodyFurniture Offer new products...</p>
                            </div>
                        </li>
                ...
                <div class="bg-white py-4 px-4 mx-6 rounded-lg mt-2.5">
                    <ul class="flex items-center">
                        ...
                        <li class="flex gap-5 items-center pl-6">
                            <img class="w-14 h-14 shadow-md shadow-slate-300" src="img/portfolio/5.jpg"
                                alt="">
                            <div>
                                <p class="font-semibold text-sm">Brown Slivel Chair.G01.2K</p>
                                <p class="text-xs pt-1 opacity-[0.6]">woodyFurniture Offer new products...</p>
                            </div>
                        </li>
                ...
                <div class="bg-white py-4 px-4 mx-6 rounded-lg mt-2.5">
                    <ul class="flex items-center">
                        ...
                        <li class="flex gap-5 items-center pl-6">
                            <img class="w-14 h-14 shadow-md shadow-slate-300" src="img/portfolio/6.jpg"
                                alt="">
                            <div>
                                <p class="font-semibold text-sm">Blue Armchair.H01.2K</p>
                                <p class="text-xs pt-1 opacity-[0.6]">woodyFurniture Offer new products...</p>
                            </div>
                        </li>
                    ...
                    <ul class="flex items-center">
                        ...
                        <li class="flex gap-5 items-center pl-6">
                            <img class="w-14 h-14 shadow-md shadow-slate-300" src="img/portfolio/1.jpg"
                                alt="">
                            <div>
                                <p class="font-semibold text-sm">Scandinavian Armchair.G03.2K</p>
                                <p class="text-xs pt-1 opacity-[0.6]">woodyFurniture Offer new products...</p>
                            </div>
                        </li>
